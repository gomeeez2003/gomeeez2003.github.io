...
const textos = {
    'es': {
        ...
        'cat-mecanica-titulo': '⚙️ Mecánica de Precisión y Ensamblaje',
        'cat-mecanica-desc': 'Mecanizado, soldadura TIG/MIG, diseño estructural y montaje de tolerancias críticas en salas blancas.',
        'cat-aditiva-titulo': '🤖 Integración Mecatrónica y Sistemas',
        'cat-aditiva-desc': 'Desarrollo de sistemas complejos, soft-robotics, automatización y ensamblaje de prototipos multidisciplinares.',
        'cat-electronica-titulo': '⚡ Sistemas Embebidos y Electrónica',
        'cat-electronica-desc': 'Control de instrumentación, diseño de PCBs, diagnóstico de equipos de electromedicina y automatización.',
        'cat-ciencia-titulo': '🔬 Ciencia Aplicada e I+D',
        'cat-ciencia-desc': 'Sistemas de ultra alto vacío (UHV), equipos de Sputtering (PVD), física de plasma y optoelectrónica.',
        ...
        'btn-volver-mecanica': '← Volver a Mecánica',
        'btn-volver-electronica': '← Volver a Electrónica',
        'btn-volver-aditiva': '← Volver a Aditiva',
        ...
        'cat-electronica-header': 'Sistemas Embebidos y Electrónica',
        'cat-electronica-subheader': 'Control de instrumentación, diseño de PCBs, diagnóstico de equipos de electromedicina y automatización.',
        ...
        'cat-ciencia-header': 'Ciencia Aplicada e I+D',
    ...
    'en': {
        ...
        'cat-mecanica-titulo': '⚙️ Precision Mechanics and Assembly',
        'cat-mecanica-desc': 'Machining, TIG/MIG welding, structural design and critical tolerance assembly in clean rooms.',
        'cat-aditiva-titulo': '🤖 Mechatronics Integration and Systems',
        'cat-aditiva-desc': 'Development of complex systems, soft-robotics, automation and assembly of multidisciplinary prototypes.',
        'cat-electronica-titulo': '⚡ Embedded Systems and Electronics',
        'cat-electronica-desc': 'Instrumentation control, PCB design, diagnostics of electromedical equipment and automation.',
        'cat-ciencia-titulo': '🔬 Applied Science and R&D',
        'cat-ciencia-desc': 'Ultra-high vacuum systems (UHV), Sputtering equipment (PVD), plasma physics and optoelectronics.',
        ...
        'cat-electronica-header': 'Embedded Systems and Electronics',
        'cat-electronica-subheader': 'Instrumentation control, PCB design, diagnostics of electromedical equipment and automation.',
        ...
        'cat-ciencia-header': 'Applied Science and R&D',
...
function initApp() {
    ...
    const SEARCH_INDEX = [
        { 
            title: { es: 'Mecánica de Precisión y Ensamblaje', en: 'Precision Mechanics and Assembly' }, 
            icon: '⚙️', 
            breadcrumb: { es: 'Categoría', en: 'Category' },
            keys: 'mecanica precision soldadura welding carricoche ayuntamiento mecanizado chasis estructural tuerca tornillo ensamblaje montaje sala blanca', 
            action: () => navegar('categoria-mecanica') 
        },
        { 
            title: { es: 'Integración Mecatrónica y Sistemas', en: 'Mechatronics Integration and Systems' }, 
            icon: '🤖', 
            breadcrumb: { es: 'Categoría', en: 'Category' },
            keys: '3d aditiva laminado nx siemens sputtering actuador flexible prototipado pneumaflex cad diseño printing mecatronica rover robot sistemas complejos soft-robotics automatización ensamblaje', 
            action: () => navegar('categoria-aditiva') 
        },
        { 
            title: { es: 'Sistemas Embebidos y Electrónica', en: 'Embedded Systems and Electronics' }, 
            icon: '⚡', 
            breadcrumb: { es: 'Categoría', en: 'Category' },
            keys: 'electronica control arduino rc digifiz nixie flash pcb electromedicina osciloscopio mk2 circuito microcontrolador embebidos instrumentación pcb diagnóstico automatización', 
        ...
        { 
            ...
            icon: '🔬', 
            breadcrumb: { es: 'Categoría', en: 'Category' },
            keys: 'ciencia investigacion id sputtering vacio plasma laser neon rubi nixie hv microscopio alto voltaje research science vacuum uhv pvd optoelectrónica', 
